...
describe("CaloriesEstimator", () => {
	...
	it("should calculate calories of cycling activity", (done: Function) => {
	...
	it("should calculate calories of running activity", (done: Function) => {
	...
	it("should not calculate calories if sportType is not supported", (done: Function) => {
	...
	it("should not calculate calories if moving time is not a number", (done: Function) => {
	...
	it("should not calculate calories if weight is not a number", (done: Function) => {
