...
export namespace CyclingPower {
    ...
    export class Estimator {
        ...
        public static csvPowerAnalysisData(csvOutputPath: string = __dirname + "/power_analysis_data.csv", endSpeed: number = 50, maxGrade: number = 25,
                                           params: Partial<CyclingPower.Params> = Estimator.DEFAULT_PARAMS): void {
