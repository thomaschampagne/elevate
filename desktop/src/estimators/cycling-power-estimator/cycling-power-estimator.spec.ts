...
describe("CyclingPowerEstimator", () => {
	...
	it("should calculate cycling power of a rider climbing a 6% hill", (done: Function) => {
	...
	it("should calculate cycling power of a rider climbing a -2% hill", (done: Function) => {
	...
	it("should calculate cycling power of a rider climbing a -10% hill", (done: Function) => {
