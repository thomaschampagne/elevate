...
import { DataActiveLap } from "@sports-alliance/sports-lib/lib/data/data-active-lap";
import { DataPowerAvg } from "@sports-alliance/sports-lib/lib/data/data.power-avg";
import moment from "moment";
import { DataSWOLF25m } from "@sports-alliance/sports-lib/lib/data/data.swolf-25m";
import { DataSWOLF50m } from "@sports-alliance/sports-lib/lib/data/data.swolf-50m";
...
import { LapJSONInterface } from "@sports-alliance/sports-lib/src/laps/lap.json.interface";
...
import { EventJSONInterface } from "@sports-alliance/sports-lib/src/events/event.json.interface";
...
import { DataPowerWork } from "@sports-alliance/sports-lib/lib/data/data.power-work";
import { DataCyclingStandingTime } from "@sports-alliance/sports-lib/lib/data/data.cycling-standing-time";
import { DataRightBalance } from "@sports-alliance/sports-lib/lib/data/data.right-balance";
import { DataPowerTorqueEffectivenessLeft } from "@sports-alliance/sports-lib/lib/data/data.power-torque-effectiveness-left";
import { DataCyclingSeatedTime } from "@sports-alliance/sports-lib/lib/data/data.cycling-seated-time";
import { DataLeftBalance } from "@sports-alliance/sports-lib/lib/data/data.left-balance";
import { DataPowerPedalSmoothnessRight } from "@sports-alliance/sports-lib/lib/data/data.power-pedal-smoothness-right";
import { DataPowerPedalSmoothnessLeft } from "@sports-alliance/sports-lib/lib/data/data.power-pedal-smoothness-left";
import { DataPowerTorqueEffectivenessRight } from "@sports-alliance/sports-lib/lib/data/data.power-torque-effectiveness-right";
import { DataStanceTimeBalanceLeft } from "@sports-alliance/sports-lib/lib/data/data-stance-time-balance-left";
import { DataStanceTimeBalanceRight } from "@sports-alliance/sports-lib/lib/data/data-stance-time-balance-right";
import { DataStanceTime } from "@sports-alliance/sports-lib/lib/data/data.stance-time";
import { DataVerticalOscillation } from "@sports-alliance/sports-lib/lib/data/data.vertical-oscillation";
import { DataVerticalRatio } from "@sports-alliance/sports-lib/lib/data/data.vertical-ratio";
import { DataAvgStrideLength } from "@sports-alliance/sports-lib/lib/data/data.avg-stride-length";
...
import { DataAnaerobicTrainingEffect } from "@sports-alliance/sports-lib/lib/data/data-anaerobic-training-effect";
import { CreatorJSONInterface } from "@sports-alliance/sports-lib/lib/creators/creator.json.interface";
import { EmptyEventLibError } from "@sports-alliance/sports-lib/lib/errors/empty-event-sports-libs.error";
import { DurationExceededEventLibError } from "@sports-alliance/sports-lib/lib/errors/duration-exceeded-event-lib.error";
