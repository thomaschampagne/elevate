...
const redirectTo = (localStorage.getItem(PromoteDesktopComponent.NO_PROMOTE_DESKTOP_MENU_LC_KEY)) ? AppRoutesModel.activities : AppRoutesModel.desktopAppUpdate;

const routes: Routes = [
	{
		path: AppRoutesModel.desktopAppUpdate,
