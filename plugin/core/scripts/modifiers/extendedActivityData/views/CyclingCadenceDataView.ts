...
export class CyclingCadenceDataView extends AbstractCadenceDataView {
    ...
    protected insertDataIntoGrid(): void {
		...
		if (hasHasPerCadenceOccurrence) {
			this.insertContentAtGridPosition(1, 3, this.cadenceData.averageDistancePerOccurrence.toFixed(2), "Avg Dist. / Crank Rev. <sup style='color:#FC4C02; font-size:12px;'>NEW</sup>", "M", "displayCadenceData");
