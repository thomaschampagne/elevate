...
export class HeaderView extends AbstractDataView {
    ...
    public render(): void {
		...
		this.content += "       <a href='" + this.appResources.settingsLink + "#/donate' target='_blank' style='font-size: 14px;'> (Do you <img style='width: 14px;' src='" + this.appResources.heartIcon + "'/> this project?)</a>";
        this.content += "   </div>";
        this.content += "</div>";
