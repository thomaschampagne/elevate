...
export class MenuModifier extends AbstractModifier {
	...
	public modify(): void {
		...
		html += "<li><a target='_blank' href='" + this.appResources.settingsLink + "#/newAppInProgress'><img style='vertical-align:middle' src='" + this.appResources.aboutIcon + "'/>&nbsp;&nbsp;&nbsp;<span>New App In Progress</span></a></li>";
		html += "<li><a target='_blank' href='" + this.appResources.settingsLink + "#/activities'><img style='vertical-align:middle' src='" + this.appResources.viewListIcon + "'/>&nbsp;&nbsp;&nbsp;<span>Activities</span></a></li>";
