...
export interface IOption {
	...
	title: string;
	labels: string[];
	markdownTemplateUri: string; // TODO Remove me when md helper template OK
	list?: IListItem[];
...
export class CommonSettingsService {
	...
	private _sections: ISection[] = [{
		...
		options: [{
			...
			labels: ["All"],
			markdownTemplateUri: "", // TODO Can be removed when md helper template OK
			min: 10,
			max: 43200, // 30 days
			step: 1,
			disableTooltip: true,
		...
		options: [{
			...
			labels: ["Running"],
			markdownTemplateUri: "This will display StravistiX extended cadence data for 2 legs instead of 1 e.g 180 SPM, not 90 SPM.",
		}, {
			key: "displayBikeOdoInActivity",
			type: "checkbox",
			title: "Enable bike odo display",
			labels: ["Cycling"],
			markdownTemplateUri: "This option allows you to display the total distance traveled with the bike which has done the activity.<br /><br />This value is displayed alongside your bike name in an activity page and is refreshed each 2 hours.<br /><br />Of course, it implies that you have declared at least 1 bike in Strava.",
		}, {
			key: "activateRunningGradeAdjustedPace",
			type: "checkbox",
			title: "Enable Grade Adjusted Pace graph",
			labels: ["Running"],
			markdownTemplateUri: "Activate running \"Grade Adjusted Pace\" graph by default in running activity analysis.<br /><br /><img src=\"img/activateRunningGradeAdjustedPace.png\"/>",
		}, {
			key: "activateRunningHeartRate",
			type: "checkbox",
			title: "Enable Heart Rate graph",
			labels: ["Running"],
			markdownTemplateUri: "Activate running heart rate graph by default in running activity analysis.<br /><br /><img src=\"img/activateRunningHeartRate.png\"/>",
		}, {
			key: "activateRunningTemperature",
			type: "checkbox",
			title: "Enable Temperature graph",
			labels: ["Running"],
			markdownTemplateUri: "Activate temperature graph by default in running activity analysis",
		}, {
			key: "activateRunningCadence",
			type: "checkbox",
			title: "Enable Cadence graph",
			labels: ["Running"],
			markdownTemplateUri: "Activate running cadence graph by default in running activity analysis.",
		}, {
			...
			markdownTemplateUri: "Do what title describes...",
		}, {
			key: "displaySegmentTimeComparisonToKOM",
			type: "checkbox",
			title: "Enabled segment time comparison to KOM/QOM display",
			labels: ["All"],
			markdownTemplateUri: "This option allows you to display the time difference between segment KOM/QOM time and the time from the activity for that segment.",
		}, {
			key: "displaySegmentTimeComparisonToPR",
			type: "checkbox",
			title: "Enabled segment time comparison to PR display",
			labels: ["All"],
			markdownTemplateUri: "This option allows you to display the time difference between segment PR time and the time from the activity for that segment.",
		}, {
			key: "displaySegmentTimeComparisonToCurrentYearPR",
			type: "checkbox",
			title: "Enabled segment time comparison to current year PR display",
			labels: ["All"],
			markdownTemplateUri: "This option allow you to display the time difference between segment current year PR time and the time from the activity for that segment.",
		}, {
			key: "displaySegmentTimeComparisonPosition",
			type: "checkbox",
			title: "Enabled segment time comparison rank column",
			labels: ["All"],
			markdownTemplateUri: "This option allow you to display as \"fast reading\" your current rank on segments in a new column on segments efforts rows.",
		}, {
			key: "reviveGoogleMaps",
			type: "checkbox",
			title: "Revive Google Maps on activities",
			labels: ["All"],
			markdownTemplateUri: "Strava has discontinued Google Maps inside the web version to use \"MapBox+OpenStreetMap\" maps.<br/><br/>This option allows you revive Google Maps and Street view features with an orange button placed near Strava native maps.<br/><br/><strong>Note:</strong> This feature is currently working only on activity pages at the moment.",
			...
			labels: ["Cycling"],
			markdownTemplateUri: "This option allows to enable best splits into your cycling activities.",
		}, {
			...
			markdownTemplateUri: "Choose your default leaderboard filter inside related segments pages. Select filter among:<br /><br />&diams; Overall<br />&diams; Men<br />&diams; Women<br />&diams; Your following/followers<br />&diams; Your results",
		}, {
			key: "displayReliveCCLink",
			type: "checkbox",
			title: "Relive your rides/runs with relive.cc",
			labels: ["Cycling", "Running"],
			markdownTemplateUri: "This will display an embedded video of your rides/runs from relive.cc service. Make sure to connect your strava account to <a href=\"http://relive.cc\" target=\"_blank\">relive.cc</a>. <br/><br/><strong>Note:</strong> Only rides/runs done after a relive.cc subscription can get a \"Relive\".",
		}],
	}, {
		...
		options: [{
			...
			title: "Segment Rank %",
			labels: ["All"],
			markdownTemplateUri: "Add your segment rank percentage on segment page. <br /><br /><img src=\"img/displaySegmentRankPercentage.png\"/>",
		}, {
			key: "displayNearbySegments",
			type: "checkbox",
			title: "Nearby Segments",
			labels: ["Cycling", "Running"],
			markdownTemplateUri: "This option displays cycling and running nearby segments on a segment page.",
		}],
		...
		options: [{
			...
			labels: ["All"],
			markdownTemplateUri: "<strong>This enable on activities page</strong><br /><br />VeloViewer activity shortcut & raceshape activity surface.<br /><br /><strong>And on segments pages...</strong><br /><br />VeloViewer segment shortcut & Jonathan Okeeffe segment details.",
		}],
	}, {
		title: "Dashboard",
		options: [{
			...
			labels: ["All"],
			markdownTemplateUri: "Automatic scrolling on activity dashboard<br /><br /><img src=\"img/feedAutoScroll.png\"/>",
		}, {
			key: "feedHideChallenges",
			type: "checkbox",
			title: "Hide challenges",
			labels: ["All"],
			markdownTemplateUri: "This will hide all related challenge items in the dashboard feed (joined, milestones reached and completed).",
		}, {
			key: "feedHideCreatedRoutes",
			type: "checkbox",
			title: "Hide created routes",
			labels: ["All"],
			markdownTemplateUri: "This will hide all routes created in the dashboard feed.",
		}, {
			key: "feedHideSuggestedAthletes",
			type: "checkbox",
			title: "Hide suggested athletes",
			labels: ["All"],
			markdownTemplateUri: "This will hide the \"You Should Follow\" section from the dashboard feed sidebar",
		}, {
			key: "feedHideVirtualRides",
			type: "checkbox",
			title: "Hide virtual rides.",
			labels: ["Cycling"],
			markdownTemplateUri: "This will hide all virtual rides in the dashboard feed.",
			min: 0,
		}, {
			...
			labels: ["Cycling"],
			markdownTemplateUri: "This will hide all cycling rides (also virtual rides) in the dashboard feed if they are under distance you set (KM or MI). Set empty value or \"0\" to display all cycling rides in your feed",
			min: 0,
		}, {
			...
			labels: ["Running"],
			markdownTemplateUri: "This will hide all running activities in the dashboard feed if they are under distance you set (KM or MI). Set empty value or \"0\" to display all running activities in your feed",
			min: 0,
		}],
	}, {
		title: "Weather units",
		options: [{
			...
			title: "Temperature",
			markdownTemplateUri: "This selects which units to use when displaying temperature on weather activity overlay.",
		}, {
			key: "windUnit",
			type: "list",
			labels: ["All"],
			...
			title: "Wind Speed",
			markdownTemplateUri: "This selects which units to use when displaying wind speed on weather pages.",
		}],
	}, {
		...
		options: [{
			...
			labels: ["Cycling"],
			markdownTemplateUri: "Note: this target/goal is independent from strava premium annual goal",
			min: 0,
		}, {
			key: "targetsYearRun",
			type: "number",
