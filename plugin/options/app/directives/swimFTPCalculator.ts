...
export interface IScopeSwimFTPCalculator extends IScope {
    calculationMethods: ISwimCalculationMethod[];
...
export class SwimFTPCalculator {
    ...
    constructor(public $scope: IScopeSwimFTPCalculator) {
        ...
        $scope.methodChanged = (selectedMethod: ISwimCalculationMethod) => {
            ...
            const othersMethods = _.reject($scope.calculationMethods, (method: any) => {
            ...
            const userSwimFtp = selectedMethod.formula(selectedMethod.params);
