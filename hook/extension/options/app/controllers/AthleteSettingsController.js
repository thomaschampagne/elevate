app.controller("AthleteSettingsController", ['$scope', 'ChromeStorageService', 'AvoidInputKeysService', '$mdDialog', function($scope, ChromeStorageService, AvoidInputKeysService, $mdDialog) {
    ...
    $scope.hintModal = function($event, title, content) {
        $mdDialog.show(
            $mdDialog.alert()
    ...
    $scope.displayUserMaxHrHelper = function($event) {
    ...
    $scope.displayUserRestHrHelper = function($event) {
    ...
    $scope.displayUserFTPHelper = function($event) {
