class AthleteSettingsController {
    ...
    constructor($scope: any, ChromeStorageService: any, AvoidInputKeysService: any, $mdDialog: any) {
        ChromeStorageService.fetchUserSettings(function (userSettingsSynced: any) {
        ...
        $scope.hintModal = function ($event: any, title: string, content: string) {
            $mdDialog.show(
                $mdDialog.alert()
        ...
        $scope.displayUserMaxHrHelper = function ($event:any) {
        ...
        $scope.displayUserRestHrHelper = function ($event:any) {
        ...
        $scope.displayUserFTPHelper = function ($event:any) {
        ...
        $scope.avoidInputKeyEdit = function ($event:any) {
            AvoidInputKeysService($event);
        };
    }
