app.factory('CommonSettingsService', [ 'TranslationService', function(TranslationService) {

    commonSettingsService = {};

    commonSettingsService.provideSections = function(callback) {

        TranslationService.init(function () {
            var sections = [{
                sectionTitle: 'Activities Extended Data',
                sectionTransKey: 'settings/common/extendedStas_section',
                sectionContent: [{
                    ...
                    optionTransKey: 'settings/common/disp_active_ratio'
                }, {
                    ...
                    optionTransKey: 'settings/common/disp_motive_score'
                }, {
                    ...
                    optionTransKey: 'settings/common/disp_adv_power_data'
                }, {
                    ...
                    optionTransKey: 'settings/common/disp_adv_hr_data'
                }, {
                    ...
                    optionTransKey: 'settings/common/disp_adv_speed_data'
                }, {
                    ...
                    optionTransKey: 'settings/common/disp_cad_data'
                }, {
                    ...
                    optionTransKey: 'settings/common/disp_adv_grade_data'
                }, {
                    ...
                    optionTransKey: 'settings/common/disp_adv_elev_data'
                }]
            }, {
                sectionTitle: 'Activity viewing options',
                sectionTransKey: 'settings/common/act_view_options',
                sectionContent: [{
                    ...
                    optionTransKey: 'settings/common/cad_both_legs'
                }, {
                    ...
                    optionTransKey: 'settings/common/bike_odo_disp'
                }, {
                    ...
                    optionTransKey: 'settings/common/enable_gap'
                }, {
                    ...
                    optionTransKey: 'settings/common/enable_hrg'
                }, {
                    ...
                    optionTransKey: 'settings/common/enable_temp_graph'
                }, {
                    ...
                    optionTransKey: 'settings/common/enable_cad_graph'
                }, {
                    ...
                    optionTransKey: 'settings/common/default_map_type'
                }, {
                    ...
                    optionTransKey: 'settings/common/enable_kom_comp'
                }, {
                    ...
                    optionTransKey: 'settings/common/enable_seg_prcomp'
                }, {
                    ...
                    optionTransKey: 'settings/common/enable_seg_yrprcomp'
                }, {
                    ...
                    optionTransKey: 'settings/common/enable_seg_rank_col'
                }, {
                    ...
                    optionTransKey: 'settings/common/rev_goog_maps'
                }, {
                    ...
                    optionHtml: 'Do what title describes...',
                    optionTransKey: 'settings/common/rev_goog_maplayer_type'
                }, {
                    ...
                    optionTransKey: 'settings/common/enable_best_splits'
                }]
            }, {
                sectionTitle: 'Segments viewing options',
                sectionTransKey: 'settings/common/seg_view_options',
                sectionContent: [{
                    ...
                    optionTransKey: 'settings/common/disp_seg_rankpercent'
                }, {
                    ...
                    optionTransKey: 'settings/common/leaderboard_filter'
                }, {
                    ...
                    optionTransKey: 'settings/common/nearby_seg'
                }, ],
            }, {
                sectionTitle: 'Activities and Segments viewing options',
                sectionTransKey: 'settings/common/act_seg_view_opt',
                sectionContent: [{
                    ...
                    optionTransKey: 'settings/common/integrate_velo_flyby'
                }],
            }, {
                sectionTitle: 'Dashboard',
                sectionTransKey: 'settings/common/dashboard_opt',
                sectionContent: [{
                    ...
                    optionTransKey: 'settings/common/feed_autoscroll'
                }, {
                    ...
                    optionTransKey: 'settings/common/hide_challenges'
                }, {
                    ...
                    optionTransKey: 'settings/common/hide_created_routes'
                }, {
                    ...
                    optionTransKey: 'settings/common/hide_ride_act_under_dist'
                }, {
                    ...
                    optionTransKey: 'settings/common/hide_run_act_under_dist'
                }]
            }, {
                sectionTitle: 'Weather units',
                sectionTransKey: 'settings/common/weather_unit',
                sectionContent: [{
                    ...
                    optionTransKey: 'settings/common/temperature'
                }, {
                    optionKey: 'windUnit',
                    optionType: 'list',
                    optionLabels: ['All'],
                    ...
                    optionTransKey: 'settings/common/wind_speed'
                }]
            }, {
                sectionTitle: 'Miscellaneous',
                sectionTransKey: 'settings/common/misc',
                sectionContent: [{
                    ...
                    optionTransKey: 'settings/common/hide_premium'
                }]
            }];
            _.each(sections, function(section) {
                if (!_.isUndefined(section.sectionTransKey))
                    section.sectionTitle = TranslationService.formatMessage(section.sectionTransKey);
                _.each(section.sectionContent, function (sectionContent) {
                    if (!_.isUndefined(sectionContent.optionTransKey)) {
                        var transText = TranslationService.formatMessage(sectionContent.optionTransKey);
                        sectionContent['optionTitle'] = transText;
                        for (var i = 0; i < sectionContent.optionLabels.length; i++) {
                            if (sectionContent.optionLabels[i] === 'Cycling')
                                sectionContent.optionLabels[i] = TranslationService.formatMessage('cycling');
                            else if (sectionContent.optionLabels[i] === 'Running')
                                sectionContent.optionLabels[i] = TranslationService.formatMessage('running');
                            else
                                sectionContent.optionLabels[i] = TranslationService.formatMessage('all');
                        }
                    }
                });
            });
