    ...
    modify: function modify() {
        ...
        $('.collapse.button').first().before(html).each(function() {
            ...
            $('#activityFlashCodebutton').click(function() {
                ...
                $.fancybox('<div align="center"><h2>#stravaplus Activity Flash code</h2><h3>Scan from smartphone to get activity on Strava mobile app.</h3><p><div style="padding: 0px 60px 0px 60px;" id="qrcode"></div></p><h3>Save by right click on image then "Save image as..."</h3></div>');
