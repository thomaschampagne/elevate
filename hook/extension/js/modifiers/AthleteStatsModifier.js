    ...
    modify: function modify() {
        ...
        var formatData = function(activities) {
            ...
            for (i = 0, max = activities.length; i < max; i++) {
                ...
                if (activity.type === "Ride" || activity.type === "Run" || activity.type === "VirtualRide") {
                    date = new Date(activity.start_time);
                    formattedData.push({
                        t: (activity.type === "Ride" || activity.type === "VirtualRide") ? 0 : 1,
                        y: date.getFullYear(),
                        m: date.getMonth(),
                        d: date.getDate(),
