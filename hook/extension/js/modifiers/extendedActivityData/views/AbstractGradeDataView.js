var AbstractGradeDataView = AbstractDataView.extend(function(base) {
    ...
    return {
        ...
        render: function() {
            ...
            // Add a title
            this.content += this.generateSectionTitle('GRADE STATS <a class="btn-sm button" target="_blank" href="' + this.appResources.settingsLink + '#/zonesSettings" style="float: right;margin-right: 5px;">Customize</a>');
