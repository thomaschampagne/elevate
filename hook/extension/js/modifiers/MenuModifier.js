...
MenuModifier.prototype = {
    ...
    modify: function modify() {
        ...
        stravaMenuHtml += "<li><a target='_blank' href='" + this.appResources_.settingsLink + "#/hrrZonesSettings'><img style='vertical-align:middle' src='" + this.appResources_.heartIcon + "'> <span>Health Settings</span></a></li>";
        ...
        stravaMenuHtml += "<li style='border-top: 1px solid #DDD;'><a style='font-style: italic;' href='" + this.appResources_.settingsLink + "#/releaseNotes' target='_blank'><img style='vertical-align:middle' src='" + this.appResources_.systemUpdatesIcon + "'/> <span><strong>" + this.appResources_.extVersionName + "</strong> release notes</span></a></li>";
