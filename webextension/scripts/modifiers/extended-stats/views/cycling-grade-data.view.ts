...
export class CyclingGradeDataView extends AbstractGradeDataView {
    ...
    protected insertDataIntoGrid(): void {
        ...
        this.insertContentAtGridPosition(
            0,
            4,
            _.isNaN(avgClimbingSpeed) || avgClimbingSpeed.toString() == "NaN"
                ? "-"
                : this.printNumber(avgClimbingSpeed, 1),
            "Avg climbing speed",
        ...
        this.insertContentAtGridPosition(
            2,
            4,
            _.isNaN(avgDownhillSpeed) || avgDownhillSpeed.toString() == "NaN"
                ? "-"
                : this.printNumber(avgDownhillSpeed, 1),
            "Avg downhill speed",
            this.speedUnitsData.speedUnitPerHour,
            "displayAdvancedGradeData"
        );
