    ...
    protected insertDataIntoGrid(): void {
        ...
        this.insertContentAtGridPosition(
            ...
            this.gradeData.upFlatDownMoveData.up / this.speedUnitsData.speedUnitFactor !== 0
                ? Helper.secondsToHHMMSS(
                      this.gradeData.upFlatDownMoveData.up / this.speedUnitsData.speedUnitFactor,
                      true
                  )
                : "-",
            "Avg climbing pace",
        ...
        this.insertContentAtGridPosition(
            ...
            this.gradeData.upFlatDownMoveData.flat / this.speedUnitsData.speedUnitFactor !== 0
                ? Helper.secondsToHHMMSS(
                      this.gradeData.upFlatDownMoveData.flat / this.speedUnitsData.speedUnitFactor,
                      true
                  )
                : "-",
            "Avg flat pace",
        ...
        this.insertContentAtGridPosition(
            ...
            this.gradeData.upFlatDownMoveData.down / this.speedUnitsData.speedUnitFactor !== 0
                ? Helper.secondsToHHMMSS(
                      this.gradeData.upFlatDownMoveData.down / this.speedUnitsData.speedUnitFactor,
                      true
                  )
                : "-",
            "Avg downhill pace",
