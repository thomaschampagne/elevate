...
export abstract class AbstractGradeDataView extends AbstractDataView {
    ...
    protected insertDataIntoGrid(): void {
        ...
        this.insertContentAtGridPosition(
            ...
            2,
            this.printNumber(
                (this.gradeData.upFlatDownInSeconds.up / this.gradeData.upFlatDownInSeconds.total) * 100,
                1
            ),
            "% climbing",
            "%",
        ...
        this.insertContentAtGridPosition(
            ...
            2,
            this.printNumber(
                (this.gradeData.upFlatDownInSeconds.flat / this.gradeData.upFlatDownInSeconds.total) * 100,
                1
            ),
            "% flat",
            "%",
        ...
        this.insertContentAtGridPosition(
            ...
            2,
            this.printNumber(
                (this.gradeData.upFlatDownInSeconds.down / this.gradeData.upFlatDownInSeconds.total) * 100,
                1
            ),
            "% downhill ",
            "%",
