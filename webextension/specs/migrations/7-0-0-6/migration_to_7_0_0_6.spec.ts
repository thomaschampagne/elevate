import { Migration7x0x0x6 } from "../../../scripts/migrations/Migration7x0x0x6";

describe("migration_to_7_0_0_6", () => {
    ...
    beforeEach(done => {
        migration = new Migration7x0x0x6();
        done();
    });
    ...
    it("should migrate a full old v6 database to the new v7 format", done => {
        ...
        expect(newDatabase.syncedActivities.binaryIndices).toEqual({
            name: {dirty: false, name: "name", values: []}, start_time: {dirty: false, name: "start_time", values: []},
