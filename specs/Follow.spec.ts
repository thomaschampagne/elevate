...
describe('Generate Athlete Update', () => {
    ...
    it('should return compliant AthleteUpdate (free)', () => {
        ...
        let doe: IAthleteUpdate = AthleteUpdate.generateAthleteUpdate(
            123,
            'John Doe',
            '5.0.0',
            false, // premium true
    ...
    it('should return compliant AthleteUpdate (pro)', () => {
        ...
        let froom: IAthleteUpdate = AthleteUpdate.generateAthleteUpdate(
            999,
            'Chris Froome',
            '5.1.0',
            false, // premium true
        ...
        // Another pro
        let cavendish: IAthleteUpdate = AthleteUpdate.generateAthleteUpdate(
            888,
            'Cavendish',
            '5.1.0',
            true, // premium true
    ...
    it('should pass monkey tests', () => {
        ...
        let monkey_01: IAthleteUpdate = AthleteUpdate.generateAthleteUpdate(
            888,
            '',
            '5.1.0',
            true, // premium true
        ...
        let monkey_02: IAthleteUpdate = AthleteUpdate.generateAthleteUpdate(
            888,
            'Monkey',
            '',
            false, // premium true
        ...
        //...
        let monkey_03: IAthleteUpdate = AthleteUpdate.generateAthleteUpdate(
            888,
            null,
            null,
            false, // premium true
