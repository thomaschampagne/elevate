...
describe("AthleteSnapshotResolverService", () => {
    ...
    it("should update the service", done => {
        ...
        spyOn(athleteSnapshotResolverService.athleteService, "fetch").and.returnValue(
        ...
        promise.then(
            () => {
                ...
                expect(
                    athleteSnapshotResolverService.athleteSnapshotResolver.athleteModel.datedAthleteSettings
                ).toEqual(datedAthleteSettingsModels);
                done();
            },
            error => {
