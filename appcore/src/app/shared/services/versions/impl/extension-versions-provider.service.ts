...
export class ExtensionVersionsProvider implements VersionsProvider {
  public static readonly MANIFEST_PRODUCTION: string =
    "https://raw.githubusercontent.com/thomaschampagne/elevate/master/plugin/manifest.json";
  ...
  public getRemoteVersion(): Promise<string> {
    return this.httpClient
      .get<chrome.runtime.Manifest>(ExtensionVersionsProvider.MANIFEST_PRODUCTION)
      .toPromise()
      .then(
        response => {
