...
describe("ExtensionDataStore", () => {
    ...
    it("should fetch empty data (vector)", done => {
    ...
    it("should fetch empty data (object))", done => {
    ...
    it("should fetch all chrome storage data (no key provided)", done => {
    ...
    it("should fetch default value when storage is empty (and no key provided)", done => {
    ...
    it("should save all chrome storage data (no key provided)", done => {
    ...
    it("should reject save data", done => {
    ...
    it("should save property of a Foo (string)", done => {
    ...
    it("should save property of a Foo (boolean)", done => {
    ...
    it("should save nested property", done => {
    ...
    it("should save nested property (no key provided)", done => {
    ...
    it("should reject save property with Foo[]", done => {
    ...
    it("should clear all chrome storage data (no key provided)", done => {
    ...
    it("should reject clear data", done => {
    ...
    it("should provide AppUsageDetails", done => {
    ...
    it("should get by id a Foo into a collection", done => {
    ...
    it("should get by id a Foo as object or property", done => {
    ...
    it("should put (create) a Foo into a collection", done => {
    ...
    it("should put (create) a Foo as object or property", done => {
    ...
    it("should put (update) a Foo into a collection", done => {
    ...
    it("should put (update) a Foo as object or property", done => {
    ...
    it("should remove by id some Foo into a collection", done => {
