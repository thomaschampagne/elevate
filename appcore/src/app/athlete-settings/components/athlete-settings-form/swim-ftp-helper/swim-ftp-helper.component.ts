    ...
    public calculationMethods: SwimCalculationMethod[] = [
        {
            ...
            params: [
                {
                    hint:
                        "Swim as far as possible during 60 minutes and enter distance performed in meters (ex: 1800 meters)",
                    value: null,
                },
            ],
        ...
        },
        {
            ...
            params: [
                {
                    hint:
                        "Swim as far as possible during 30 minutes and enter distance performed in meters (ex: 950 meters)",
                    value: null,
                },
            ],
            formula: (params: FormulaParamsModel[]) => {
