...
export class ShareComponent implements OnInit {
  public static readonly TWEET: string =
    "https://twitter.com/intent/tweet?text=As%20an%20athlete%2C%20you%20should%20try" +
  ...
  public static readonly FACEBOOK_POST: string =
    "https://www.facebook.com/sharer/sharer.php?u=https%3A//www.facebook.com/elevatestrava";
