...
@Component({
    ...
    template: `
        <h2 mat-dialog-title>Detected {{syncedActivityModels.length}} activit{{syncedActivityModels.length > 1 ? 'ies' : 'y'}} with missing stress scores due to lack of functional
            thresholds</h2>
        <div class="mat-h3">➞ Please provide your functional thresholds in dated athlete settings to cover below activit{{syncedActivityModels.length > 1 ? 'ies' : 'y'}}</div>
            ...
            <table mat-table [dataSource]="dataSource">
                ...
                <ng-container matColumnDef="lackof">
                    ...
                    <td mat-cell *matCellDef="let activity">
                        <span *ngIf="activity.type === ElevateSport.Ride || activity.type === ElevateSport.VirtualRide">Cycling FTP</span>
                        <span *ngIf="activity.type === ElevateSport.Run || activity.type === ElevateSport.VirtualRun">Running FTP</span>
