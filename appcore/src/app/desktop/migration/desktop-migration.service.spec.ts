...
describe("DesktopMigrationService", () => {
	...
	it("should detect upgrade", (done: Function) => {
	...
	it("should not detect upgrade when saved & package version are same", (done: Function) => {
	...
	it("should not detect upgrade when no saved version", (done: Function) => {
	...
	it("should detect downgrade", (done: Function) => {
	...
	it("should trigger upgrade", (done: Function) => {
	...
	it("should track package version from newly migrated version", (done: Function) => {
