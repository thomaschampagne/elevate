...
@Component({
  ...
  template: `
    ...
    <mat-dialog-content class="mat-body-1">
      <div>
        If you don't own or sometimes forgot your sensors, your fitness trend can be nevertheless estimated. A "typical"
        iPhone or Android mobile user who runs the strava mobile app can access the fitness trend feature without buying
        any external sensors 👍. Nevertheless sensors are highly recommended if you need a more accurate trend.
      </div>
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                <a [routerLink]="'/athleteSettings'" (click)="dialogRef.close()">dated athlete settings</a>. A wrong ftp
              ...
              <li>
                ...
                allowing strava to estimate power data on your next cycling activities (required to compute <i>PSS</i>).
              </li>
              <li>
                ...
                <a
                  ...
                  >Notes</a
                >
                to fix your activities if needed. A "Clear and re-sync activities" can be required after any fix.
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li>
                ...
                <a [routerLink]="'/athleteSettings'" (click)="dialogRef.close()">dated athlete settings</a>.
              </li>
            </ul>
          </li>
        </ul>
