...
export class FitnessTrendConfigDialogComponent implements OnInit {
  ...
  public ngOnInit(): void {
    if (this.fitnessTrendConfigDialogData.fitnessTrendConfigModel.ignoreActivityNamePatterns) {
      this.ignoreActivityNamePatterns = this.formatPatternsForDisplay(
    ...
    if (this.fitnessTrendConfigDialogData.fitnessTrendConfigModel.ignoreBeforeDate) {
      this.ignoreBeforeDate = moment(
        this.fitnessTrendConfigDialogData.fitnessTrendConfigModel.ignoreBeforeDate
      ).toDate();
    }
  ...
  public updateEstimatedStressScoresToggles(): void {
    this.isEstimatedPowerStressScoreToggleEnabled =
    ...
    this.isEstimatedRunningStressScoreToggleEnabled =
      this.fitnessTrendConfigDialogData.fitnessTrendConfigModel.heartRateImpulseMode === HeartRateImpulseMode.HRSS;
  }
  ...
  public onModeChange(): void {
    this.fitnessTrendConfigDialogData.fitnessTrendConfigModel.heartRateImpulseMode = Number(
      this.fitnessTrendConfigDialogData.fitnessTrendConfigModel.heartRateImpulseMode
    );
    this.updateEstimatedStressScoresToggles();
  }
  ...
  public onIgnoreBeforeDateChange(): void {
    this.fitnessTrendConfigDialogData.fitnessTrendConfigModel.ignoreBeforeDate = this.ignoreBeforeDate
      ? this.ignoreBeforeDate.toISOString()
      : null;
  }
