...
export class AddYearProgressPresetDialogComponent implements OnInit {
    ...
    public ngOnInit(): void {
        if (this.dialogData.mode === ProgressMode.YEAR_TO_DATE) {
            this.progressPresetModel = new YearToDateProgressPresetModel(
                this.dialogData.yearProgressTypeModel.type,
                this.dialogData.activityTypes,
                this.dialogData.includeCommuteRide,
                this.dialogData.includeIndoorRide,
                this.dialogData.targetValue
            );
        } else {
            const rollingPresetDialogData = new AddRollingProgressPresetDialogData(
                this.dialogData.yearProgressTypeModel,
                this.dialogData.activityTypes,
                this.dialogData.includeCommuteRide,
                this.dialogData.includeIndoorRide,
                this.dialogData.targetValue,
            ...
            this.progressPresetModel = new RollingProgressPresetModel(
                rollingPresetDialogData.yearProgressTypeModel.type,
                rollingPresetDialogData.activityTypes,
                rollingPresetDialogData.includeCommuteRide,
                rollingPresetDialogData.includeIndoorRide,
                rollingPresetDialogData.targetValue,
                rollingPresetDialogData.rollingPeriod,
                rollingPresetDialogData.periodMultiplier
            );
        }
    }

    public onSave(): void {
        this.yearProgressService
            .addPreset(this.progressPresetModel)
            .then(() => {
