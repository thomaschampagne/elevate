...
@Component({
    ...
    template: `
        ...
        <mat-dialog-content class="mat-body-1">
            <div>
                The <strong>rolling progression</strong> mode helps you to analyze your training volume/intensity
                variations over a <i>"customise-able fixed rolling time window"</i> which slides every day.
            </div>

            <div>
                This is the total <i>"distance"</i>, <i>"time"</i>, <i>"elevation"</i> OR <i>"activity count"</i> you
                were able to maintain during this window. And this day after day. In long endurance sports, volume and
                intensity are the keys for success. Leaving apart intensity which can be obtained with Stress Scores
                (HRSS, PSS, ...), the rolling progression provides the simplest part of the equation which is hard to
                get right: <strong>the volume</strong>.
            </div>

            <div>
                By combining rolling progression with "targets", you will be able to track and ensure a defined training
                volume pace overtime (use the presets feature to define targets).
            </div>

            <div>To enable the <strong>rolling progression</strong>, just select "Rolling" in the mode field.</div>
