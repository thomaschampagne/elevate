...
export namespace ActivityColumns {
    ...
    export class Definition {
        ...
        public static readonly ALL: Column<SyncedActivityModel>[] = [
            ...
            new NumberColumn(
                Category.HEART_RATE,
                "extendedStats.heartRateData.averageHeartRate",
                "bpm",
                "Avg HR"
            ).setDefault(true),
            ...
            new NumberColumn(
                Category.POWER,
                "extendedStats.powerData.lowerQuartileWatts",
                "w",
                "25% Watts"
            ).setDescription("Lower Quartile Watts"),
            new NumberColumn(Category.POWER, "extendedStats.powerData.medianWatts", "w", "50% Watts").setDescription(
                "Median Watts"
            ),
            new NumberColumn(
                Category.POWER,
                "extendedStats.powerData.upperQuartileWatts",
                "w",
                "75% Watts"
            ).setDescription("Upper Quartile Watts"),
