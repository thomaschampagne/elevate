...
export let releaseNotesData: ReleaseNoteModel[] = [
  {
    version: "7.0.0-6.alpha",
    date: "yyyy-mm-dd",
    message: "Current work in progress alpha version",
    hotFixes: [],
    features: [],
    isPatch: false,
    fixes: [],
  },
  {
    ...
    date: "2020-06-23",
    message:
      "At a glance: Fixed GPS virtual partner export & extended stats panel not working on activities segments efforts. Update also includes other fixes and improvements.",
    hotFixes: [],
    features: [],
    isPatch: true,
    fixes: [
  ...
  },
  {
    ...
    date: "2020-02-26",
    message:
      '👨‍⚕️💉 UI issues bugfixes. Note: v6.16.x introduces Cycling Power Curve on your ride activities and "Elevate Extended Stats" on ALL activities types (nordic ski, rowing, ...).',
    hotFixes: [],
    features: [],
    isPatch: true,
    fixes: [
  ...
  },
  {
    ...
    date: "2020-02-08",
    message:
      '✨ Added Cycling Power Curve on your ride activities!! ✨ Added "Elevate Extended Stats" on ALL activities types (nordic ski, rowing, ...). Update also adds various improvements & bugs fixes.',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2019-12-01",
    message:
      '"✨ New desktop cross-platform app in progress. Details in the "New App In Progress" section of Elevate. Update also adds various improvements & bugs fixes.',
    hotFixes: ["Fixed syncing date not updated"],
    features: ['Added "New desktop app in progress" menu', "Optimized the activities search feature"],
    isPatch: false,
    fixes: [
  ...
  },
  {
    ...
    date: "2019-09-28",
    message:
      "✨ New UI engine implemented within Elevate App. Elevate UI should be faster than ever. Update also adds various improvements & bugs fixes.",
    hotFixes: [],
    features: [
    ...
    isPatch: false,
    fixes: ["Fixed activities not exported properly to spreadsheet when a filter is applied"],
  },
  {
    version: "6.13.0",
    date: "2019-07-06",
    message:
      '✨ New "Running Performance Index" statistic added to your running activities. Update also adds various improvements & bugs fixes',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2019-05-22",
    message:
      'Added "calories" column in "Activities" section of elevate app. Update also adds various improvements & bugs fixes',
    hotFixes: [],
    features: [
    ...
    isPatch: false,
    fixes: ["[Technical] Upgraded Angular & others npm libraries."],
  },
  {
    version: "6.11.1",
    date: "2019-04-16",
    message:
      '👨‍⚕️💉 Fixed issues with Dated Athlete Settings. <u>V6.11 Reminder</u>: New "Activities" menu in Elevate App: List activities with ALL EXTENDED STATS (+ spreadsheet export feature).',
    hotFixes: [],
    features: ["Check the 6.11.0 release note for features related to v6.11.x"],
    isPatch: true,
    fixes: [
  ...
  },
  {
    ...
    date: "2019-03-30",
    message:
      'New "Activities" menu in Elevate App: List activities with ALL EXTENDED STATS (+ spreadsheet export feature).',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2019-03-17",
    message:
      '👨‍⚕️💉 Fixed some syncing errors + Year progressions not displayed in some cases + Restored activity summary stats panel. <u>V6.10 Reminder</u>: Analyze your training volume variations and intensity with the new "Rolling" mode available in "Year progressions".',
    hotFixes: [
    ...
    features: ["Check the 6.10.1 release note for features related to v6.10.x"],
    isPatch: true,
    fixes: [],
  },
  {
    ...
    date: "2019-02-28",
    message:
      'NEW!! Analyze your training volume variations and intensity with the new "Rolling" mode available in "Year progressions". Improvements & fixes have been also pushed.',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2019-02-18",
    message:
      "🔥 Hotfix 🔥 After days & nights of work, all the broken features are now mostly fixed: Elevate now manages the new technical restrictions introduced by Strava on their servers. V6.9.x Reminder: Support of Manual & Virtual running in Fitness Trend. Details in release note.",
    hotFixes: [
    ...
    features: ["Check the 6.9.0 release note for features related to v6.9.x"],
    isPatch: true,
    fixes: [],
  },
  {
    ...
    date: "2019-02-11",
    message:
      "👨‍⚕️💉 Patch: After some users requests, the old year progressions had to be revived temporally. V6.9 Reminder: Support of Manual & Virtual running in Fitness Trend (⚠️ Read release notes to enable it).",
    hotFixes: [],
    features: ["Check the 6.9.0 release note for features related to v6.9.x"],
    isPatch: true,
    fixes: [
  ...
  },
  {
    ...
    date: "2018-12-24",
    message:
      'Patching "Year Progressions Targets & Presets" with improvements and bug fixes. View full release note for details.',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-11-18",
    message:
      "Added year progressions Targets & Presets. Added Analysis Graph for Running activities. And many improvements visible in release note...",
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-10-25",
    message:
      'Added chronological activity feed (activate feature from global settings). Added new data-field "Best 60min heart rate". This update also brings important improvements and fixes (details in release note).',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-09-10",
    message:
      "Hotfixed the new v6.5 which introduces \"Dated Athlete Settings\". Since your physiological attributes evolve over time, this feature will provide matching athlete's attributes for a given activity date to calculate stats with actual day's attributes. Go to athlete settings to enable it.",
    hotFixes: ['Fixed inability to delete a "dated athlete settings" in v6.5.0'],
    features: [],
    isPatch: true,
    fixes: [],
  },
  {
    ...
    date: "2018-09-09",
    message:
      "Big update! Introducing \"Dated Athlete Settings\". Since your physiological attributes evolve over time, this feature will provide matching athlete's attributes for a given activity date to calculate stats with actual day's attributes. Go to athlete settings to enable it.",
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-08-10",
    message:
      'Version 6.4.* patched. (Reminder) Version 6.4 adds "Fitness Trend Estimation" for users without sensor, "Running Stress Score (RSS)" to activities and fitness trend, "Fitness Trend" options to exclude activities from the trend, "Fitness Trend Spreadsheet Export" feature.',
    hotFixes: [],
    features: ['Adds "fitness, fatigue & form deltas" with previous day on fitness trend tooltips'],
    isPatch: true,
    fixes: [
  ...
  },
  {
    ...
    date: "2018-07-07",
    message:
      'Added "Fitness Trend Estimation" for users WITHOUT SENSORS!!. Added "Running Stress Score (RSS)" to activities and fitness trend. Added "Fitness Trend" options to exclude activities from the trend. Added a "Fitness Trend Spreadsheet Export" feature. And more improvements.',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-06-08",
    message:
      'Added zoom in/out actions on fitness trend graph. Added indoor activity filter on year progressions. New "adaptive low-pass filter" to improve accuracy of estimated power data: estimated "Power Stress Score" accuracy is also positively impacted. And more in the release note...',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-05-12",
    message:
      'Added "best 20 min cycling speed" and "best 20 min running pace" data-fields on your activities. Also added an option to define your own starting fitness and fatigue values on your fitness trend. Rest of the update focuses mainly on noticeable optimizations.',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-04-22",
    message:
      'Added year progression global overview (click "overview" button in year progression). Release 6.1.* improves "Fitness Trend" accuracy with HRM. Adds  ' +
      new Date().getFullYear() +
      ' delta comparison in "Year progressions". Adds data-fields: HRSS, HRSS/Hour, Best 20min HR & Best 20min Power.',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-04-09",
    message:
      'Big 6.1.* update! Strongly improved the "Fitness Trend" accuracy using a heart rate monitor. Added  ' +
      new Date().getFullYear() +
      ' delta comparison for each year of "Year progressions" feature. Added new data-fields: HRSS, HRSS/Hour, Best 20min Heart Rate and Best 20min Power.',
    hotFixes: [],
    features: [],
    isPatch: true,
    fixes: [
  ...
  },
  {
    ...
    date: "2018-04-02",
    message:
      'Big update! Strongly improved the "Fitness Trend" accuracy using a heart rate monitor. Added  ' +
      new Date().getFullYear() +
      ' delta comparison for each year of "Year progressions" feature. Added new data-fields: HRSS, HRSS/Hour, Best 20min Power and Best 20min Heart Rate.',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-03-18",
    message:
      'Third patch of <strong>NEW APP</strong> released in February. Mainly bugs fixes and improvements. Click "show details" for more info.',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-03-11",
    message:
      "2nd big patch of the brand <strong>NEW APP</strong>!. Fitness trend look has been reworked along your feedbacks. And fitness graph is now linked to fitness table. And tons of other things...",
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2018-02-25",
    message:
      "First patch of the brand <strong>NEW app</strong>! Fitness trend, years progress & others features have been fully remade! A <strong>new start</strong> to go further!",
    hotFixes: [],
    features: [
      "Remade and improved fitness trend feature",
      "Remade and improved year progressions",
  ...
  },
  {
    ...
    date: "2018-02-18",
    message:
      "Brand <strong>NEW app</strong> released! Fitness trend, years progress & others features have been fully remade! This <strong>new start</strong> was required to go further!",
    hotFixes: [],
    features: [
      "Remade and improved fitness trend feature",
      "Remade and improved year progressions",
  ...
  },
  {
    ...
    date: "2018-01-28",
    message:
      "Added Power estimation on <strong>your</strong> runs <span style='text-decoration: line-through;'>(beta)</span> " +
  ...
  },
  {
    ...
    date: "2017-12-02",
    message:
      "Some bug fixes <strong style='font-size: 16px'>+</strong> Added cycling crank revolution distance stats <strong style='font-size: 16px'>+</strong> Running stride length (with total steps) <strong style='font-size: 16px'>+</strong> Running power estimation (Beta: must be enabled in beta settings section)",
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2017-11-01",
    message:
      "Added cycling crank revolution distance stats <strong style='font-size: 16px'>+</strong> Running stride length (with total steps) <strong style='font-size: 16px'>+</strong> Running power estimation (Beta: must be enabled in beta settings section)",
    hotFixes: [],
    features: [
      "Added Running stats: Stride length & total steps.",
      "Added Cycling stats: Crank revolution distance. The distance travelled for a crank revolution.",
  ...
  },
  {
    ...
    date: "2017-10-02",
    message:
      '<i>Hot fixed year progress missing in strava "My Profile" page.</i> <strong>V5.11.0 note:</strong> Added cadence pace on climbs, flats & downhills sections. And max uphill & downhill grades. And more...',
    hotFixes: [],
    features: [
    ...
    isPatch: true,
    fixes: ['Fixed year progressions missing in strava "My Profile" page'],
  },
  {
    version: "5.11.0",
    date: "2017-09-10",
    message:
      "NEW: Added cadence pace on climbs, flats or downhills sections. And max uphill & downhill grades. And more...",
    hotFixes: [],
    features: [
      "Added average cadence pace when on climbs, flats or downhills sections",
      "Added max uphill & downhill grades on activities pages.",
    ...
    isPatch: false,
    fixes: ["Fixed QRcode feature not working anymore on activities pages"],
  },
  {
    version: "5.10.1",
    date: "2017-08-08",
    message:
      'NEW: Added TCX export to "GPS Real Time Segments Efforts": Challenge yourself outside against a ghost! Plugin\'s performance has been also greatly improved !!',
    hotFixes: ["Fixed TCX export as Course instead of Activity (feature: GPS Real Time Segments Efforts)"],
    features: [
  ...
  },
  {
    ...
    date: "2017-07-20",
    message:
      "NEW: Export segments efforts to your GPS device and challenge yourself outside against a virtual friend, a pro or your ghost!",
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2017-06-30",
    message:
      'Improvements on years progressions and "Relive" feature (Replay your Rides & Runs inside your activity pages with relive.cc)',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2017-04-06",
    message:
      "New Year progressions improvements (Old version reactivated in Strava profile page) <strong>+</strong> Custom running power zones <strong>+</strong> Hide Virtual Rides",
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2017-03-19",
    message:
      "Added New Year progressions <strong>+</strong> Custom running power zones <strong>+</strong> Hide Virtual Rides",
    hotFixes: [],
    features: [
      "Added New Year progression UI.",
      "Added custom running power zones (was linked to cycling power zones before)",
    ...
    isPatch: false,
    fixes: ["Fixed plugin running on strava.com/api/*"],
  },
  {
    version: "5.6.1",
    date: "2017-03-09",
    message:
      "<i>(5.6.1: Fast fix on the new swimming fitness trend support)</i></br></br><strong>NEW:</strong> Swimming is now supported in multi-sport fitness trend!!</br></br><strong>Fitness trend</strong> is now completely <strong>ready</strong> for <strong>triathletes</strong> :)</br></br> It's also working with swimming activities entered manually :) No heart rate monitor is required for swimming! Your 10$ stopwatch should be good enough ;) !",
    hotFixes: [
  ...
  },
  {
    ...
    date: "2017-03-08",
    message:
      "Swimming is now supported in multi-sport fitness trend!!</br></br><strong>Fitness trend</strong> is now completely <strong>ready</strong> for <strong>triathletes</strong> :)</br></br> It's also working with swimming activities entered manually :) No heart rate monitor is required for swimming! Your 10$ stopwatch should be good enough ;) !",
    hotFixes: [],
    features: [
      'Added Swimming support inside multi-sport fitness trend by using your swim FTP.</br><i>Note: this type of activity where not supported by default (via HR data and thus "trimps") because strava swimming activities don\'t keep HR data.</i>',
      "Improved history synchronization. Synchronization continues where she stopped earlier (in case of any type of interruption).",
    ...
    isPatch: false,
    fixes: ["Fixed date comparison bug on additional goal progress tracking."],
  },
  {
    version: "5.5.0",
    date: "2017-02-22",
    message:
      "At a glance...</br>Cycling Power Stress Score on your activities :)</br>" +
  ...
  },
  {
    ...
    date: "2017-02-13",
    message:
      "<i>Patch release: Now calculating TRIMP over elapsed time instead of moving time. TRIMP were not properly computed with activities without movements.<br/>You may need to perform a full sync of your synced history for the fitness trend feature. Memory management during synchronization of your history has been also improved.</i>",
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2017-02-03",
    message:
      "<strong>5.4.1:</strong> <i>Bug fix release</i></br></br><strong>5.4.0 features reminder:</strong> MultiSports Fitness Trend now use your cycling power meter to compute your fitness when available.",
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2017-01-26",
    message:
      "MultiSports Fitness Trend now use your cycling power meter to compute your fitness when available.</br></br>Swimming is not supported properly in fitness trend... Now taking care of swimmers ;) Still in Beta isn't it ?^^;)",
    hotFixes: [],
    features: [
      "Fitness trend can now use your cycling power meter to compute your fitness.",
      'Strava premium additional goal progress is back! Still "experimental". Activate it from Hidden feature section',
  ...
  },
  {
    ...
    hotFixes: [],
    features: ["MultiSports Fitness Trend released as beta"],
    isPatch: false,
    fixes: [],
  },
  {
    ...
    date: "2016-12-20",
    message:
      "MultiSports Fitness Trend here. Sync process fully reworked!. Last alpha testing version optimistically.</br></br>" +
  ...
  },
  {
    ...
    date: "2016-12-11",
    message:
      'MultiSports Fitness Trend live! Improvements + fixes. Short nights :D. Feature still in "test".</br>' +
  ...
  },
  {
    ...
    date: "2016-12-07",
    message:
      '<i>"MultiSports Fitness Trend"</i> Alpha <strong>V3</strong> fast released! Include fixes of Alpha V2+V1... Feature works with all activities where you held a heart rate monitor. Not only cycling...</br></br>Sticky note: <i>"Premium additional goal progress tracking"</i> disabled. Still few bugs around to fix :/ Feature is available in common settings by the way (hidden section)',
    hotFixes: [],
    features: [],
    isPatch: true,
    fixes: ['Fixed majors bugs of <i>"MultiSports Fitness Trend"</i> Alpha V2+V1'],
  },
  {
    version: "5.0.1",
    date: "2016-12-06",
    message:
      '<i>"MultiSports Fitness Trend"</i> Alpha V2 here! Mainly bugs fixed of Alpha V1... Thanks to testers! It works with all activities where you held a heart rate monitor. Not only cycling... </br></br>Also disabled <i>"Premium additional goal progress tracking"</i>. Still few bugs around to fix :/ Feature is available in common settings by the way (hidden section)',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2016-12-03",
    message:
      "<i>MultiSports Fitness Trend released as Alpha !<br /><br />After long days of work, It's now live! Yeah! <br/><br/>Working with all activities where you held a heart rate monitor. Not only cycling...</i>",
    hotFixes: [],
    features: ["MultiSports fitness trend."],
    isPatch: false,
    fixes: [],
  },
  {
    ...
    hotFixes: [],
    features: ["Added monthly and weekly targets for strava premium annual goals"],
    isPatch: false,
    fixes: [
  ...
  },
  {
    ...
    hotFixes: ["Hot fix monthly and weekly targets number format"],
    features: ["Added monthly and weekly targets for strava premium annual goals"],
    isPatch: false,
    fixes: ["Fixed extended stats graph to get Y axis always starting from zero"],
  },
  {
    version: "4.5.0",
    date: "2016-11-17",
  ...
  },
  {
    ...
    hotFixes: [],
    features: ["Segment time comparison on all activity types."],
    isPatch: false,
    fixes: [
  ...
  },
  {
    ...
    date: "2016-10-22",
    message:
      'Fixing bugs from 4.2.2</br></br><strong>NEW as BETA:</strong> Added running estimated paces & cycling estimated powers from your most painful effort on a segment. The feature visible on "Your recent efforts" graph displayed in segment pages. <div style="text-align: center;"></div>',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    date: "2016-10-17",
    message:
      '<strong>NEW as BETA:</strong> Added running estimated paces & cycling estimated powers from your most painful effort on a segment. The feature visible on "Your recent efforts" graph displayed in segment pages. <div style="text-align: center;"></div>',
    hotFixes: [],
    features: [
      "BETA: Cycling estimated powers based on your most painful effort on a segment.",
      "BETA: Running estimated paces based on your most painful effort on a segment.",
  ...
  },
  {
    ...
    date: "2016-10-15",
    message:
      'NEW: Added running estimated paces & cycling estimated powers from your most painful effort on a segment. The feature visible on "Your recent efforts" graph displayed in segment pages.',
    hotFixes: [],
    features: [
  ...
  },
  {
    ...
    hotFixes: ["Fixed a crash that could occur on several activities opened."],
    features: [
  ...
  },
  {
    ...
    hotFixes: ["Fixed a crash that could occur in older version of chrome (under v53)"],
    features: [
      "Extended stats on Trainer Rides (where speed was not recorded)",
      'Invisible enhancement to prepare future: Moved 50% of the JS code to <a href="https://www.typescriptlang.org/" target="_blank">Microsoft TypeScript</a> (Geeks and developers could understand ;))',
    ],
  ...
  },
  {
    ...
    isPatch: false,
    fixes: ["Fixed technical error which occured in plugin packaging with gulp"],
  },
  {
    version: "4.0.1",
    date: "2016-09-04",
  ...
  },
  {
    ...
    hotFixes: [],
    isPatch: true,
    features: ["Added Hidden/Beta feature section.", "Added Relive.cc as Hidden/Beta feature."],
    fixes: ["Fix HR info in other athlete's activities don't make sense with user max/min HR."],
  },
  {
    version: "3.10.0",
    date: "2016-08-15",
  ...
  },
  {
    version: "3.9.1",
    date: "2016-08-03",
    features: ["Fix pace display glitch in athlete summary"],
  },
  {
    version: "3.9.0",
    date: "2016-07-17",
  ...
  },
  {
    version: "3.8.1",
    date: "2016-07-01",
    features: ["HotFixing best splits"],
  },
  {
    version: "3.8.0",
    date: "2016-06-22",
  ...
  },
  {
    version: "3.5.1",
    date: "2016-05-13",
    features: ["HotFixed disappearance of 'My year progressions to current month / day' (My Profile page)"],
  },
  {
    version: "3.5.0",
    date: "2016-05-13",
  ...
  },
  {
    version: "3.2.3",
    date: "2016-03-26",
    features: ["Disable elevate on new strava store", "Minors improvements"],
  },
  {
    version: "3.2.2",
    date: "2016-03-11",
    features: ["Hotfix Wrong running climbing pace on extended panel"],
  },
  {
    version: "3.2.1",
    date: "2016-03-09",
  ...
  },
  {
    version: "2.2.2",
    date: "2015-12-30",
    features: ["FIX: Javascript syntax error while processing activities extended stats."],
  },
  {
    version: "2.2.1",
    date: "2015-12-15",
  ...
  },
  {
    version: "2.1.1",
    date: "2015-12-02",
    features: ["FIX: Not getting extension stats on big ride (>300km)"],
  },
  {
    version: "2.1.0",
    date: "2015-11-30",
  ...
  },
  {
    version: "2.0.1",
    date: "2015-11-17",
    features: ["HotFix: Null powers are computed in power best splits. They were removed from computation before."],
  },
  {
    version: "2.0.0",
    date: "2015-11-15",
  ...
  },
  {
    version: "1.2.1",
    date: "2015-11-09",
    features: ["Fix Year progression chart icon which may invisible"],
  },
  {
    version: "1.2.0",
    date: "2015-11-02",
  ...
  },
  {
    version: "1.0.2",
    date: "2015-10-16",
    features: ["Fix map display problem while cropping ride. Google maps API was loaded twice."],
  },
  {
    version: "1.0.1",
    date: "2015-10-08",
  ...
  },
  {
    version: "0.7.8",
    date: "2015-09-07",
    features: ["Add Pedaling time to summary panel", "Add median cadence to summary panel", "Various bug fixes"],
  },
  {
    version: "0.7.7",
    date: "2015-08-07",
  ...
  },
  {
    version: "0.7.5",
    date: "2015-07-02",
    features: ["Hotfix: Year progress sometimes not visible"],
  },
  {
    version: "0.7.4",
    date: "2015-07-01",
  ...
  },
  {
    version: "0.7.2",
    date: "2015-06-04",
    features: ["Improve weather accuracy"],
  },
  {
    version: "0.7.1",
    date: "2015-05-29",
    features: ["Hotfix: Remove display elevate chrome tab on update (http://thomaschampagne.github.io/elevate)"],
  },
  {
    version: "0.7.0",
    date: "2015-05-28",
  ...
  },
  {
    version: "0.6.2",
    date: "2015-05-01",
    features: ["Exporting segment effort as Virtual Partner for your GPS through activity page."],
  },
  {
    version: "0.6.1",
    date: "2015-04-23",
    features: ["OpenStreetMap flipper for activities (from Veloviewer)"],
  },
  {
    version: "0.6.0",
    date: "2015-04-15",
  ...
  },
  {
    version: "0.5.4",
    date: "2015-03-19",
    features: ["Runners can view avanced pace data", "Major bugs fixed from 0.5.3"],
  },
  {
    version: "0.5.3",
    date: "2015-03-16",
  ...
  },
  {
    version: "0.5.2",
    date: "2015-03-15",
    features: ["HotFix for 0.5.1: some dependencies could not be loaded resulting in extension crash."],
  },
  {
    version: "0.5.1",
    date: "2015-03-15",
  ...
  },
  {
    version: "0.4.10",
    date: "2015-03-07",
    features: ["Add share extension links to twitter"],
  },
  {
    version: "0.4.9",
    date: "2015-02-27",
    features: ["Add Segment Details remote link on segment page"],
  },
  {
    version: "0.4.8",
    date: "2015-02-22",
  ...
  },
  {
    version: "0.4.5",
    date: "2015-02-08",
    features: ["Fast fix from version 0.4.4. Sry for this..."],
  },
  {
    version: "0.4.4",
    date: "2015-02-08",
  ...
  },
  {
    version: "0.4.1",
    date: "2015-01-28",
    features: ["Options GUI look better especially on checkboxes", "Minor fixes"],
  },
  {
    version: "0.4.0",
    date: "2015-01-27",
  ...
  },
  {
    version: "0.3.9",
    date: "2015-01-02",
    features: ["Fix kom-map to achievement-map"],
  },
  {
    version: "0.3.8",
    date: "2014-12-16",
    features: ["Fix nearby segment icons away"],
  },
  {
    version: "0.3.7",
    date: "2014-11-11",
  ...
  },
  {
    ...
    date: "2014-11-02",
    features: ["Fixed display text glitches on some pages", "Elevate menu icon orange", "Others minor bug fixes"],
  },
  {
    version: "0.3.1",
    date: "2014-10-30",
  ...
  },
  {
    version: "0.1.11",
    date: null,
    features: ["More Stable", "Prepare future for big features..."],
  },
  {
    version: "0.1.10",
    date: null,
    features: ["Add Watts/KG for cycling activities", "Add VeloViewer Challenges Trophy Cabinet to Elevate menu"],
  },
  {
    version: "0.1.9",
    date: null,
    features: ["Bike odo on activities back", "Weighted Power calculation adjusted for cycling activities"],
  },
  {
    version: "0.1.8",
    date: null,
  ...
  },
  {
    version: "0.1.4",
    date: null,
    features: ["Display bike odo on activity page", "Bugs fixing"],
  },
  {
    version: "0.1.3",
    date: null,
