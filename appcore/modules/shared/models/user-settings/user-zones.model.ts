...
export class UserZonesModel {
    ...
    public static readonly DEFAULT_MODEL: UserZonesModel = {
        ...
        ascent: [0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1200, 1400, 1600, 1800, 2000, 2200, 2400, 2600, 2800, 3000, 3200, 3400, 3600, 3800,
            4000, 4200, 4400, 4600, 4800, 5000, 6000]
    };
